...
def main():
    ...
    number_of_classes_per_client = 10 // num_clients
    ...
    federated_learning = FederatedLearning(
        global_model1=ResNetModel(model_name="resnet18", num_classes=10),
        global_model2=ResNetModel(model_name="resnet50", num_classes=10),
